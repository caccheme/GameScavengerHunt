...
//    }
    ...
    private void launchGameView(String GameId) {
        Intent intent = new Intent(CurrentGames.this, ViewGame.class);
    ...
    private void setupButtonCallbacks() {
      ...
      menuButton.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View v) {
          finish();
          Intent i = new Intent(CurrentGames.this, MainMenuActivity.class);
          CurrentGames.this.startActivity(i);
        }
      });
    }
}